...
# variable 18 for DMA
dat_exp2<- dat_exp[c(1,3,5,7,8,11,13,15,17,19,21,23,25,26,28,30,32,34,36,38,40,42,44,46,48,49,51,53,55,57:60,62)]
...
dat_exp_out<- inner_join(dat_exp2, wppsi, by="subject_id") |> drop_na()
...
correlation plot
```{r}
cormat<- round(x=cor(dat_exp_out[c(2:34)], method = "spearman", 
