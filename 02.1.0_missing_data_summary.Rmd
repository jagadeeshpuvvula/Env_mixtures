...
ggplot(missing_data_long_filtered, aes(x = Observations, y = reorder(Variables, -as.numeric(Missing)), fill = Missing)) +
  ...
  guides(fill = guide_legend(direction = "horizontal",  title.hjust = 0.5, title="Unmeasured")) +
