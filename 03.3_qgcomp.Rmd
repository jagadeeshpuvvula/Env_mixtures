...
```{r}
results<- get_gcomp_estimates(results_folder = "E:/BBK17/pj/data_2023apr/results/qgcomp/qgcomp_29chem")

write_csv(results, "E:/BBK17/pj/data_2023apr/results/qgcomp/qgcomp_29chem/r_obj_summ.csv")
```
...
```{r}
qgcomp_weights <- extract_weights("E:/BBK17/pj/data_2023apr/results/qgcomp/qgcomp_29chem")
write_csv(qgcomp_weights, "E:/BBK17/pj/data_2023apr/results/qgcomp/qgcomp_29chem/chem_weight.csv")
```

# load chemical weights
```{r}
qgcomp_weights<- read_csv("E:/BBK17/pj/data_2023apr/results/qgcomp/lasso_29chem/chem_weight.csv")
```
