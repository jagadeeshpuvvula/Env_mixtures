...
out_wide <- dt_outcome |>
  pivot_wider(names_from = visit, values_from = c(wppsi_fsiq, wisc_fsiq)) |>
  clean_names()
...
dat_out <- out_wide |>
  select(c(1,6)) |> drop_na()
write_csv(dat_out, "/Users/jpuvvula/Documents/data/wppsi_wisc_repla.csv")
```
...
```{r}
cov <- read_csv("E:/BBK17/pj/wppsi_analy_dat/home_export/home-covar_mire_transf.csv") |>
  select(c(1:10)) |>
  clean_names()
