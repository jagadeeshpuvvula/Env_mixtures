...
```{r}
ggsave("E:/BBK17/pj/data_2023apr/results/bkmr/29_chem/29_chem_est.tiff", 
       width = 16,height = 10,
       dpi=300)
```
...
# extract pips
```{r}
pip_df<- extract_pips("E:/BBK17/pj/data_2023apr/results/bkmr/29_chem")
write_csv(pip_df, "E:/BBK17/pj/data_2023apr/results/bkmr/29_chem/29_chem.csv")
```
...
#getting estimates for the paper

```{r}
overall_risk<- results[2] |>
  as.data.frame()|>
  clean_names()|>
