...
dat<- dt_outcome[c(1,16:18,20,21,23:26,30, 34:40,42:44,46:55,60:63)] 
...
Creatnine adjustment  
```{r}
cre<- read_csv("/Users/jpuvvula/Documents/data/home_16w_imp/creat_sg.csv") |>
  filter(visit=="16W")

dt<- read_csv("/Users/jpuvvula/Documents/data/home_16w_imp/DMA_16w.csv") 

dat<- inner_join(dt,cre, by="subject_id")

dat$dma_cr <- (dat$result.res/dat$creat)
dat<- dat[c(1,2,8)] |> rename(dma = result.res) |>
  pivot_longer(!subject_id, names_to = "analyte", values_to = "conc")

write_csv(dat, "/Users/jpuvvula/Documents/data/home_16w_imp/mirec_transf/dmaa.csv")

```

wide to long lipid adjusted and whole blood samples
```{r}
dat<- read_csv("/Users/jpuvvula/Documents/data/home_16w_imp/pfos_16w.csv") 
dat<- dat[c(1,2)] |> rename(pfos = result.res) |>
  pivot_longer(!subject_id, names_to = "analyte", values_to = "conc")

write_csv(dat, "/Users/jpuvvula/Documents/data/home_16w_imp/mirec_transf/pfos.csv")
```
...
write_csv(dat, "/Users/jpuvvula/Documents/data/home_16w_imp/mirec_transf/exp_fin_summary.csv")
```
