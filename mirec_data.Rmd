...
wppsi_fin<- inner_join(wppsi,dat, by="subject_id") |> drop_na()
basc_fin<- inner_join(dat, basc_brief[c(2:5)], by="subject_id") |> drop_na()
brief_fin<- inner_join(dat,basc_brief[c(2,6,7)], by="subject_id") |> drop_na()
```
