...
nb_gcomp_fit<- qgcomp.noboot(wppsi_fsiq ~ .+cohort+city+sex+race_bin+
                               cotinine+mom_edu_cat+home_score_total+
                               parity_n+mom_age,
                             expnms = mixture,
                             data = dat,
...
gcomp_fit<- qgcomp.boot(wppsi_fsiq ~ .+cohort+city+sex+race_bin+
                               cotinine+mom_edu_cat+home_score_total+
                               parity_n+mom_age,
                        expnms = mixture,
                        data = dat,
...
nb_gcomp_fit<- qgcomp.noboot(wppsi_viq ~ .+cohort+city+sex+race_bin+
                               cotinine+mom_edu_cat+home_score_total+
                               parity_n+mom_age,
                             expnms = mixture,
                             data = dat,
...
gcomp_fit<- qgcomp.boot(wppsi_viq ~ .+cohort+city+sex+race_bin+
                               cotinine+mom_edu_cat+home_score_total+
                               parity_n+mom_age,
                        expnms = mixture,
                        data = dat,
...
nb_gcomp_fit<- qgcomp.noboot(wppsi_piq ~ .+cohort+city+sex+race_bin+
                               cotinine+mom_edu_cat+home_score_total+
                               parity_n+mom_age,
                             expnms = mixture,
                             data = dat,
...
gcomp_fit<- qgcomp.boot(wppsi_piq ~ .+cohort+city+sex+race_bin+
                               cotinine+mom_edu_cat+home_score_total+
                               parity_n+mom_age,
                        expnms = mixture,
                        data = dat,
...
nb_gcomp_fit<- qgcomp.noboot(wppsi_fsiq ~ .+sex+race_bin+
                               cotinine+mom_edu_cat+home_score_total+
                               parity_n+mom_age,
                             expnms = mixture,
                             data = dat_home,
...
gcomp_fit<- qgcomp.boot(wppsi_fsiq ~ .+sex+race_bin+
                               cotinine+mom_edu_cat+home_score_total+
                               parity_n+mom_age,
                        expnms = mixture,
                        data = dat_home,
...
```{r, echo=FALSE, message=FALSE, fig.height=12, fig.width=12, dpi=300}
set.seed(123, "L'Ecuyer-CMRG")
nb_gcomp_fit<- qgcomp.noboot(wppsi_viq ~ .+sex+race_bin+
                               cotinine+mom_edu_cat+home_score_total+
                               parity_n+mom_age,
                             expnms = mixture,
                             data = dat_home,
...
gcomp_fit<- qgcomp.boot(wppsi_viq ~ .+sex+race_bin+
                               cotinine+mom_edu_cat+home_score_total+
                               parity_n+mom_age,
                        expnms = mixture,
                        data = dat_home,
...
nb_gcomp_fit<- qgcomp.noboot(wppsi_piq ~ .+sex+race_bin+
                               cotinine+mom_edu_cat+home_score_total+
                               parity_n+mom_age,
                             expnms = mixture,
                             data = dat_home,
...
gcomp_fit<- qgcomp.boot(wppsi_piq ~ .+sex+race_bin+
                               cotinine+mom_edu_cat+home_score_total+
                               parity_n+mom_age,
                        expnms = mixture,
                        data = dat_home,
...
nb_gcomp_fit<- qgcomp.noboot(wppsi_fsiq ~ .+city+sex+race_bin+
                               cotinine+mom_edu_cat+home_score_total+
                               parity_n+mom_age,
                             expnms = mixture,
                             data = dat_mirec,
...
gcomp_fit<- qgcomp.boot(wppsi_fsiq ~ .+city+sex+race_bin+
                               cotinine+mom_edu_cat+home_score_total+
                               parity_n+mom_age,
                        expnms = mixture,
                        data = dat_mirec,
...
```{r, echo=FALSE, message=FALSE, fig.height=12, fig.width=12, dpi=300}
set.seed(123, "L'Ecuyer-CMRG")
nb_gcomp_fit<- qgcomp.noboot(wppsi_viq ~ .+city+sex+race_bin+
                               cotinine+mom_edu_cat+home_score_total+
                               parity_n+mom_age,
                             expnms = mixture,
                             data = dat_mirec,
...
gcomp_fit<- qgcomp.boot(wppsi_viq ~ .+city+sex+race_bin+
                               cotinine+mom_edu_cat+home_score_total+
                               parity_n+mom_age,
                        expnms = mixture,
                        data = dat_mirec,
...
```{r, echo=FALSE, message=FALSE, fig.height=12, fig.width=12, dpi=300}
set.seed(123, "L'Ecuyer-CMRG")
nb_gcomp_fit<- qgcomp.noboot(wppsi_piq ~ .+city+sex+race_bin+
                               cotinine+mom_edu_cat+home_score_total+
                               parity_n+mom_age,
                             expnms = mixture,
                             data = dat_mirec,
...
gcomp_fit<- qgcomp.boot(wppsi_piq ~ .+city+sex+race_bin+
                               cotinine+mom_edu_cat+home_score_total+
                               parity_n+mom_age,
                        expnms = mixture,
                        data = dat_mirec,
