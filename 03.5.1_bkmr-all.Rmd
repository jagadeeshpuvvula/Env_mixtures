...
# extract pips
```{r}
pip_df<- extract_pips("E:/BBK17/pj/data_2023apr/results/bkmr/lasso_pos14chem")
write_csv(pip_df, "E:/BBK17/pj/data_2023apr/results/bkmr/lasso_pos14chem/lasso_14chem.csv")
```
...
write_csv(pip_df, "bkmr_pips.csv")
```
