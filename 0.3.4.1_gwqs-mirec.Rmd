...
save(nb_fsiq_neg, file = "E:/BBK17/pj/wppsi_results/gwqs/mirec/nb_fsiq_neg.rda")
summary(nb_fsiq_neg)  
...
save(rh_fsiq_neg, file = "E:/BBK17/pj/wppsi_results/gwqs/mirec/rh_fsiq_neg.rda")
summary(rh_fsiq_neg)  
...
save(nb_fsiq_pos, file = "E:/BBK17/pj/wppsi_results/gwqs/mirec/nb_fsiq_pos.rda")
summary(nb_fsiq_pos)  
...
save(rh_fsiq_pos, file = "E:/BBK17/pj/wppsi_results/gwqs/mirec/rh_fsiq_pos.rda")
summary(rh_fsiq_pos)  
...
save(nb_viq_neg, file = "E:/BBK17/pj/wppsi_results/gwqs/mirec/nb_viq_neg.rda")
summary(nb_viq_neg)  
...
save(rh_viq_neg, file = "E:/BBK17/pj/wppsi_results/gwqs/mirec/rh_viq_neg.rda")
summary(rh_viq_neg)  
...
save(nb_viq_pos, file = "E:/BBK17/pj/wppsi_results/gwqs/mirec/nb_viq_pos.rda")
summary(nb_viq_pos)  
...
rh_viq_pos <- gwqsrh(wppsi_viq_lg ~wqs+sex+race_bin+cotinine+mom_edu_cat+
                       home_score_total+parity_n+mom_age, mix_name = mixture,
                     data = dat,
                     q=10, validation=0.4,b=100,b1_pos = T,b1_constr = F,
                     family="gaussian",seed=2023, rh=100)

save(rh_viq_pos, file = "E:/BBK17/pj/wppsi_results/gwqs/mirec/rh_viq_pos.rda")
summary(rh_viq_pos)  
...
save(nb_piq_neg, file = "E:/BBK17/pj/wppsi_results/gwqs/mirec/nb_piq_neg.rda")
summary(nb_piq_neg)  
...
save(rh_piq_neg, file = "E:/BBK17/pj/wppsi_results/gwqs/mirec/rh_piq_neg.rda")
summary(rh_piq_neg)  
...
save(nb_piq_pos, file = "E:/BBK17/pj/wppsi_results/gwqs/mirec/nb_piq_pos.rda")
summary(nb_piq_pos)  
...
piq - ALL - positive direction - unconstrained model - with repeated holdout
```{r, echo=FALSE, message=FALSE, fig.height=12, fig.width=12, dpi=300}
#100 bootstraps and 100 repeated holdouts 
rh_piq_pos <- gwqsrh(wppsi_piq_lg ~wqs+sex+race_bin+cotinine+mom_edu_cat+
                       home_score_total+parity_n+mom_age, mix_name = mixture,
                     data = dat,
                     q=10, validation=0.5,b=100,b1_pos = T,b1_constr = F,
                     family="gaussian",seed=2023, rh=100)

save(rh_piq_pos, file = "E:/BBK17/pj/wppsi_results/gwqs/mirec/rh_piq_pos.rda")
summary(rh_piq_pos)  
