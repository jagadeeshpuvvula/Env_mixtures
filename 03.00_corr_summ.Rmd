...
ggplot(cormat, aes(x = var2, y = var1, fill = value)) + #, label = value
  ...
  geom_vline(xintercept = c(0, 3.5, 9.5, 12.5,  16.5, 18.5, 24.5, 26.5, 29.5), color = "black", size=1.25) +
  geom_hline(yintercept = c(0, 3.5, 9.5, 12.5, 16.5, 18.5, 24.5, 26.5, 29.5), color = "black", size=1.25) 
