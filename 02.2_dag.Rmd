...
tidy_ggdag<- dagify(
  out ~ exp ,
  exp ~ race + edu + coti + cohort + city,
  out ~ sex + age + HOME + pari + cohort+ city,
  sex ~ coti+ pari,
  coti ~ race+ edu,
  pari ~ race+ edu+ age ,
  HOME ~ edu+ race,
  ...
  exposure = "exp",
  outcome = "out",
  coords = list(x= c(exp= 3, out= 9, race= 4, edu= 5, age= 7,  pari= 7, coti= 3, sex= 9, HOME= 4, cohort= 7, city = 6),
                y=c(exp= 2, out= 2, race= 3, edu= 3, age= 4,  pari= 6, coti= 5, sex= 8.5, HOME= 9, cohort= 0, city = 0)),
  labels = c("out" = "Child \ncognitive \nabilities",
             "exp" = "Prenatal \nchemical \nbiomarkers",
             "race" = "Race",
             "edu" = "Maternal \neducation",
