...
dat<- dat |>
  mutate(wppsi_fsiq=as.numeric(scale(dat$wppsi_fsiq), center=T))|>
  mutate(wppsi_viq=as.numeric(scale(dat$wppsi_piq, center=T)))|>
  mutate(wppsi_piq=as.numeric(scale(dat$wppsi_viq, center=T)))
```
