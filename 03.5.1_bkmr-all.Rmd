...
#adding content for revision
```{r}
load("E:/BBK17/pj/data_2023apr/results/bkmr/29_chem/bkmr_all_all_wppsi_piq.rda")
load("E:/BBK17/pj/data_2023apr/results/bkmr/29_chem/bkmr_all_all_wppsi_viq.rda")
load("E:/BBK17/pj/data_2023apr/results/bkmr/29_chem/bkmr_all_all_wppsi_fsiq.rda")
```

```{r}
risks_fsiq <- bkmr::SingVarRiskSummaries(fit = bkmr_fsiq,
                                         qs.diff = c(0.25, 0.75), 
                                         q.fixed = c(0.50),
                                         method = "exact")

risks_viq <- bkmr::SingVarRiskSummaries(fit = bkmr_viq,
                                         qs.diff = c(0.25, 0.75), 
                                         q.fixed = c(0.50),
                                         method = "exact")


risks_piq <- bkmr::SingVarRiskSummaries(fit = bkmr_piq,
                                         qs.diff = c(0.25, 0.75), 
                                         q.fixed = c(0.50),
                                         method = "exact")


write_csv(combined_df, "E:/BBK17/pj/data_2023apr/results/bkmr/29_chem/bkmr_50th_pct_res.csv")
```

#combine results and plot
```{r}
combined_df <- bind_rows(FSIQ = risks_fsiq, 
                         PIQ = risks_piq, 
                         VIQ = risks_viq, 
                         .id = "source") |>
...
```{r}
ggsave("E:/BBK17/pj/data_2023apr/results/bkmr/29_chem/50th_pct_plot.tiff", 
       width = 8,height = 8,
       dpi=300)
```
