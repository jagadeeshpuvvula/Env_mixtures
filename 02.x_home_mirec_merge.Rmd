...
```{r}
mirec<- read_csv("E:/BBK17/pj/wppsi_analy_dat/exp_out-mirec.csv")
  

home<- read_csv("E:/BBK17/pj/wppsi_analy_dat/home_export/wppsi-exp_wide.csv")
...
write_csv(dat, "E:/BBK17/pj/wppsi_exp_out_comb/wppsi.csv")
```
