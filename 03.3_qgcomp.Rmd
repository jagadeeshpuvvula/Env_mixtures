...
qgcomp_func(outcomes = c("wppsi_fsiq", "wppsi_viq", "wppsi_piq"), 
            output_folder = "E:/BBK17/pj/data_2023apr/results/qgcomp/lasso_pos_14chem_wo_wisc", 
            include_sex = TRUE, include_cohort = TRUE, 
            chemicals = "~log_Hg+log_DMA+log_DDE+log_PCB_118+log_PCB_180+log_PFOA+log_PFOS+log_BCEtP+
            log_DBuP+log_sigma_DEHP+log_MIBP+log_di_Methyl_OP+log_B_PB+log_M_PB+",
...
```{r}
results<- get_gcomp_estimates(results_folder = "E:/BBK17/pj/data_2023apr/results/qgcomp/lasso_pos_14chem_wo_wisc")

write_csv(results, "E:/BBK17/pj/data_2023apr/results/qgcomp/lasso_pos_14chem_wo_wisc/r_obj_summ.csv")
```
...
#export figure
```{r}
ggsave("E:/BBK17/pj/data_2023apr/results/qgcomp/lasso_pos_14chem_wo_wisc/lasso_pos_14chem_wo_wisc_plot.tiff", 
       width = 8.5,height = 6,
       dpi=300)
```
...
```{r}
qgcomp_weights <- extract_weights("E:/BBK17/pj/data_2023apr/results/qgcomp/lasso_pos_14chem_wo_wisc")
write_csv(qgcomp_weights, "E:/BBK17/pj/data_2023apr/results/qgcomp/lasso_pos_14chem_wo_wisc/chem_weight.csv")
```
