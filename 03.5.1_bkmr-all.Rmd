...
#lasso assisted variable selection
```{r}
...
```{r}
results <- extract_data_from_folder("E:/BBK17/pj/data_2023apr/results/bkmr/16_chem")
```
...
ggplot(overall_risk, aes(overall_risk_df.quantile, overall_risk_df.est, 
    ...
    facet_grid(overall_risk_df.data_name~overall_risk_df.outcome_name*overall_risk_df.measure_name, scales = "free_y", space = "free_y")+
