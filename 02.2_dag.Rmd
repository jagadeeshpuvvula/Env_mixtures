...
tidy_ggdag<- dagify(
  out ~ exp ,
  exp ~ race + edu + coti + cohort + city+ age,
  out ~ sex + age + HOME + pari + cohort+ city+ coti+ edu+ race,
  #sex ~ coti+ pari,
  coti ~ race+ edu,
  pari ~ race+ edu+ age ,
  HOME ~ edu+ race,
  ...
  coords = list(x= c(exp= 3, out= 9, race= 4, edu= 5, age= 7,  
                     pari= 7, coti= 3, sex= 9, HOME= 4, cohort= 7, city = 6),
                y=c(exp= 2, out= 2, race= 6, edu= 3.5, age= 4,  pari= 6, 
